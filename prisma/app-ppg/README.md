...
This template helps you get started with [Prisma Postgres](https://www.prisma.io/blog/announcing-prisma-postgres-early-access) on Underscore.is.

## Getting started

Follow these instructions once this project is opened in Underscore.is.
...
Once the database is ready, copy the `DATABASE_URL` environment variable and set it in your environment.
