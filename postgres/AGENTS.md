# Underscore.is AI Rulus for PostgreSQL Projects
...
The project is configured to use a PostgreSQL database service that is automatically managed within the Underscore.is environment. Here are the key details of the setup:
