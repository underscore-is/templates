# Underscore.is AI Rules for Node.js with Express Projects
...
### Building AI Features with OpenAI-Compatible APIs

You can integrate AI capabilities into your Express application using any OpenAI-compatible API.
...
AI_API_ENDPOINT="https://api.openai.com/v1"  # Or your provider's endpoint
```
Make sure to add `.env` to your `.gitignore` file to keep it out of version control.

**3. Create an AI-Powered API Route:**
Here is a complete example of how to add a new route to your Express app that uses an AI API to generate content based on a user's prompt.
...
// Initialize the OpenAI client (works with any OpenAI-compatible API)
const openai = new OpenAI({
  apiKey: process.env.AI_API_KEY,
  baseURL: process.env.AI_API_ENDPOINT, // Optional: custom endpoint
});
...
This setup provides a secure and efficient way to add AI capabilities to your Node.js and Express backend.
